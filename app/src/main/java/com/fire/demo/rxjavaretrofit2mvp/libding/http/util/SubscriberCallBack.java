package com.fire.demo.rxjavaretrofit2mvp.libding.http.util;

import android.net.ParseException;
import android.util.Log;

import com.fire.demo.rxjavaretrofit2mvp.R;
import com.fire.demo.rxjavaretrofit2mvp.libding.http.exception.ResultException;
...
public class SubscriberCallBack<T> extends Subscriber<T> {
    ...
    public void onError(Throwable e) {
        ...
        Log.i("MVPDemo", Log.getStackTraceString(e));
